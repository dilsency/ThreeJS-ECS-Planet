...
> **Project-agnostic version:** the general technique (memoized shader-source
> and texture caching, the uniforms-vs-`#define` distinction that makes it
> lossless, free `WebGLPrograms` sharing) is distilled, free of this project's
> specifics, in
> `~/Syncthing/🗣️ claude conversations/threejs/HUD_OVERLAY_AND_ASSET_CACHING_THREEJS.md`
