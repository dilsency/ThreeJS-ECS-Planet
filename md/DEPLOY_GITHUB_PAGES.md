...
> **Project-agnostic version:** the reusable deploy mechanics and gotchas here
> (base path, `assetsInclude` for shaders, `public/` for PWA assets, GitHub
> Actions vs. the raw-branch trap) are distilled, free of this project's
> specifics, in
> `~/Syncthing/🗣️ claude conversations/threejs/VITE_PWA_GITHUB_PAGES_THREEJS.md`
