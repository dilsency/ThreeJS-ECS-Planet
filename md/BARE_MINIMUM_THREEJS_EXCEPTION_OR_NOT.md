...
> **Project-agnostic version:** the reusable patterns worked out here (hook /
> template methods, self-lookup vs. resolve-and-pass vs. self-attach, safe
> caching of resolved lookups, constructor-vs-`initialize()` timing) are
> distilled, free of this project's specifics, in
> `~/Syncthing/🗣️ claude conversations/threejs/ECS_DESIGN_PATTERNS_THREEJS.md`
