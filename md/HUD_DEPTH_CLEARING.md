...
> **Project-agnostic version:** the general technique (two-scene/two-camera HUD
> passes with `autoClear = false` + `clearDepth()`, and why that beats
> `depthTest: false`) is distilled, free of this project's specifics, in
