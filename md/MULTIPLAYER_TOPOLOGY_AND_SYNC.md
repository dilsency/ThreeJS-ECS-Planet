...
> **Project-agnostic version:** the general patterns here (full-mesh vs.
> host-relay, roster-based mesh formation and its convergence bug, the typed
> message envelope, robust quaternion transform sync, `beforeunload` disconnect
> detection) are distilled, free of this project's specifics, in
> `~/Syncthing/🗣️ claude conversations/threejs/BROWSER_MULTIPLAYER_THREEJS.md`
